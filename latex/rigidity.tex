...
\begin{align}
\val(\game_\CHSH;\strategy) &= \Pr_{(x,y)\sim \mu} \big( f(x)\oplus g(y) = x\wedge y \big) \notag\\
...
&\leq \frac{1}{2} + \frac{1}{8} \cdot 2\,=\, \frac{3}{4}\;.\label{{equation-chsh-qval1}}
\end{align}
...
\begin{align}
(A_0 B_0 + A_0 B_1 + A_1 B_0 - A_1 B_1 )^2 &=\big( (A_0+A_1) B_0 + (A_0-A_1) B_1 \big)^2\label{eq:bellop}\\
