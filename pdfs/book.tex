...
\section{Notation}
\label{introduction-section-notation}

This is an equation:
\begin{equation}
\hypertarget{0004}{}
\reversemarginpar\marginnote{\textnormal{0004}}
\label{introduction-eq:me-state}
...
\hypertarget{0006}{}
\reversemarginpar\marginnote{\textnormal{0006}}
\label{nonlocalgames}


% \phantomsection
% \label{nonlocalgames-section-phantom}
...
\hypertarget{0007}{}
\reversemarginpar\marginnote{\textnormal{0007}}
\section{Games and strategies}
\label{nonlocalgames-section-strat}

\begin{definition}[Two-player one-round games]
\hypertarget{0008}{}
\reversemarginpar\marginnote{\textnormal{0008}}
  \label{nonlocalgames-def:game}
...
\hypertarget{0009}{}
\reversemarginpar\marginnote{\textnormal{0009}}
  \label{nonlocalgames-def:tensor-product-strategy}
...
\hypertarget{000A}{}
\reversemarginpar\marginnote{\textnormal{000A}}
  \label{nonlocalgames-def:tensor-product-value}
...
\hypertarget{000B}{}
\reversemarginpar\marginnote{\textnormal{000B}}
  \label{nonlocalgames-def:projective-strategy}
...
\begin{remark}
\hypertarget{000C}{}
\reversemarginpar\marginnote{\textnormal{000C}}
  \label{nonlocalgames-rem:symmetric-games}
...
\begin{lemma}
\hypertarget{000D}{}
\reversemarginpar\marginnote{\textnormal{000D}}
  \label{nonlocalgames-lem:symmetric-strat}
...
\begin{definition}
\hypertarget{000E}{}
\reversemarginpar\marginnote{\textnormal{000E}}
  \label{nonlocalgames-def:comm-strategy}
...
\hypertarget{000F}{}
\reversemarginpar\marginnote{\textnormal{000F}}
  \label{nonlocalgames-def:consistent-measurement}
...
\hypertarget{000G}{}
\reversemarginpar\marginnote{\textnormal{000G}}
  \label{nonlocalgames-def:consistent-strategy}
...
\begin{definition}
\hypertarget{000H}{}
\reversemarginpar\marginnote{\textnormal{000H}}
  \label{nonlocalgames-def:spcc}
...
\hypertarget{000J}{}
\reversemarginpar\marginnote{\textnormal{000J}}
  \label{nonlocalgames-def:ent}
...
\hypertarget{000K}{}
\reversemarginpar\marginnote{\textnormal{000K}}
\section{Distance measures}
\label{nonlocalgames-section-distancemeasures}

We introduce several distance measures that are used throughout.

\begin{definition}[Distance between states]
\hypertarget{000L}{}
\reversemarginpar\marginnote{\textnormal{000L}}
  \label{nonlocalgames-def:state-distance}
...
\hypertarget{000M}{}
\reversemarginpar\marginnote{\textnormal{000M}}
  \label{nonlocalgames-def:consistency}
...
\hypertarget{000N}{}
\reversemarginpar\marginnote{\textnormal{000N}}
  \label{nonlocalgames-def:povm-distance}
	Let $\mX$ be a finite set and $\mu$ a distribution on $\mX$. 
...
\hypertarget{000P}{}
\reversemarginpar\marginnote{\textnormal{000P}}
  \label{nonlocalgames-def:strategy-distance}
...
\hypertarget{000Q}{}
\reversemarginpar\marginnote{\textnormal{000Q}}
  \label{nonlocalgames-fact:agreement}
...
\hypertarget{000R}{}
\reversemarginpar\marginnote{\textnormal{000R}}
    \label{nonlocalgames-item:consistency-implies-approx}
  \item If $A^x_a \otimes I_\bob \approx_\delta I_\alice \otimes B^x_a$
    \emph{and} $\{A^x_a\}$ and $\{B^x_a\}$ are projective measurements, then
    $A^x_a \otimes I_\bob \simeq_\delta I_\alice \otimes B^x_a$.
\hypertarget{000S}{}
\reversemarginpar\marginnote{\textnormal{000S}}
    \label{nonlocalgames-item:both-projectors-implies-consistency}
...
\hypertarget{000T}{}
\reversemarginpar\marginnote{\textnormal{000T}}
    \label{nonlocalgames-item:one-projector-implies-consistency}
  \end{enumerate}
\end{fact}

\begin{fact}[Fact 4.20 in~\cite{NW19}]
\hypertarget{000U}{}
\reversemarginpar\marginnote{\textnormal{000U}}
  \label{nonlocalgames-fact:add-a-proj}
...
\begin{fact}
\hypertarget{000V}{}
\reversemarginpar\marginnote{\textnormal{000V}}
\label{nonlocalgames-fact:add-a-proj2}
...
\begin{lemma}
\hypertarget{000W}{}
\reversemarginpar\marginnote{\textnormal{000W}}
\label{nonlocalgames-lem:cool-closeness-fact}
...
\hypertarget{000X}{}
\reversemarginpar\marginnote{\textnormal{000X}}
  \label{nonlocalgames-fact:triangle}
...
\hypertarget{000Y}{}
\reversemarginpar\marginnote{\textnormal{000Y}}
 \label{nonlocalgames-fact:triangle-for-simeq}
...
\hypertarget{000Z}{}
\reversemarginpar\marginnote{\textnormal{000Z}}
  \label{nonlocalgames-fact:data-processing}
...
\begin{lemma}
\hypertarget{0010}{}
\reversemarginpar\marginnote{\textnormal{0010}}
  \label{nonlocalgames-lem:commutation-analysis}
...
\reversemarginpar\marginnote{\textnormal{0011}}
    \label{nonlocalgames-eq:commutation-analysis-1}
...
\reversemarginpar\marginnote{\textnormal{0012}}
    \label{nonlocalgames-eq:commutation-analysis-2}
    \begin{split}
...
\reversemarginpar\marginnote{\textnormal{0013}}
    \label{nonlocalgames-eq:commutation-analysis-3}
...
\reversemarginpar\marginnote{\textnormal{0014}}
    \label{nonlocalgames-eq:commutation-analysis-4}
...
%\begin{lemma}
%\label{nonlocalgames-lem:avg-closeness}
...
%
%\begin{lemma}
%\label{nonlocalgames-lem:povm-to-obs}
...
\begin{lemma}
\hypertarget{0015}{}
\reversemarginpar\marginnote{\textnormal{0015}}
  \label{nonlocalgames-lem:ld-sandwich}
...
\reversemarginpar\marginnote{\textnormal{0016}}
    \label{nonlocalgames-eq:ld-sandwich-1}
...
\reversemarginpar\marginnote{\textnormal{0017}}
    \label{nonlocalgames-eq:ld-sandwich-2}
...
\hypertarget{0018}{}
\reversemarginpar\marginnote{\textnormal{0018}}
  \label{nonlocalgames-lem:pasting}
...
\reversemarginpar\marginnote{\textnormal{0019}}
  \label{nonlocalgames-eq:pasting-1}
...
\reversemarginpar\marginnote{\textnormal{001A}}
  \label{nonlocalgames-eq:pasting-2}
...
\reversemarginpar\marginnote{\textnormal{001B}}
  \label{nonlocalgames-eq:pasting-2a}
...
%
%\begin{lemma}[Orthonormalization lemma]\label{nonlocalgames-lem:ortho}
...
%\begin{equation}\label{nonlocalgames-eq:cons-cond} 
%Q_a \abc Q_a \,.
%\end{equation}
...
%\begin{equation}\label{nonlocalgames-eq:cons-ccl}
...
% \phantomsection
% \label{complexitytheory-section-phantom}
...
% \phantomsection
% \label{operatoralgebras-section-phantom}
...
\hypertarget{001H}{}
\reversemarginpar\marginnote{\textnormal{001H}}
\label{paulibraiding}


% \phantomsection
% \label{paulibraiding-section-phantom}



\hypertarget{001J}{}
\reversemarginpar\marginnote{\textnormal{001J}}
\section{Multiplayer games}
\label{paulibraiding-section-multigames}
...
\begin{equation}
\hypertarget{001K}{}
\reversemarginpar\marginnote{\textnormal{001K}}
\label{paulibraiding-eq:me-state}
 \ket{\phi_d} \,=\,\frac{1}{\sqrt{d}} \sum_{i=1}^d \ket{i}\ket{i}
\end{equation}
...
% \phantomsection
% \label{theargument-section-phantom}
...
% \phantomsection
% \label{questionreduction-section-phantom}
...
% \phantomsection
% \label{answerreduction-section-phantom}
...
% \phantomsection
% \label{recursivecompression-section-phantom}
...
% \phantomsection
% \label{parallelrepetition-section-phantom}
