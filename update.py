...
if out or any('No such file or directory' in msg for msg in err) or args.force:
    ...
    stdin, stdout, stderr = ssh.exec_command('cd /root/mipstar/latex && plastex --renderer=Gerby ./make_doc.tex --dir=/root/mipstar/make_doc/')
    stdin.write('y\n')
    ...
    if not args.nopdf and args.force:
